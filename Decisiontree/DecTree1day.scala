...
//use the features that 1-trading-day before the target date to predict the close price on the target date -- over 1-day time horizon
...
println("SMAPE on validation data = " + smape_test)
