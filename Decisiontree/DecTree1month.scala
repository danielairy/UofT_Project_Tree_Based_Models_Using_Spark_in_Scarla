...
//use the features that 20-trading-day before the target date to predict the close price on the target date -- over 1-month time horizon
val lag2 = lag("Close",-20,0).over(particionwindow)
